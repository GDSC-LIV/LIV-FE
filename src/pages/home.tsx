          ...
          <Box sx={{ width: '100%', overflowX: 'auto', whiteSpace: 'nowrap' }}>
            ...
            >
              <BottomNavigationAction
                ...
                icon={
                  <Button
                    variant={selectedCategory === '프로젝트 모집' ? 'contained' : 'outlined'}
              ...
              <BottomNavigationAction
                ...
                icon={
                  <Button
                    variant={selectedCategory === '광고나 홍보성 글' ? 'contained' : 'outlined'}
                    sx={{ whiteSpace: 'nowrap' }}
                  >
                    광고나 홍보성 글
                  </Button>
              ...
              />
              <BottomNavigationAction
                value="개인 맞춤형 자동 피드보기"
                icon={
                  <Button
                    variant={selectedCategory === '개인 맞춤형 자동 피드보기' ? 'contained' : 'outlined'}
                    sx={{ whiteSpace: 'nowrap' }}
                  >
                    개인 맞춤형 자동 피드보기
                  </Button>
          ...
          {selectedCategory === '광고나 홍보성 글' && (
            <div className="bg-white p-4 shadow-sm rounded-lg mt-4 relative">
              <div className="flex items-center space-x-4">
                ...
                />
                <div>
                  <h3 className="font-semibold">user222</h3>
                  <p className="text-gray-600">iOS Developer</p>
                </div>
              </div>
              <h4 className="font-semibold mt-4">프로젝트 주제</h4>
